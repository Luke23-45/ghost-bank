...
- [ ] **3 main tables + 6 appendix tables** per `table_plan.md` (supersedes Section 7)
- [ ] 38-set library retained, regenerable on demand
- [ ] Implementation per Section 8, output under `outputs/paper/`
- [ ] Open items in `table_plan.md` §7 resolved (epochs 70 vs 71; a4 matched Δforgetting confirmed +4.50; s3 significance; BWT for a1–s4 in report text)
