...
training objective, and the static bank also uses a different readout; these
protocol differences are detailed in the appendix.  Figure~\ref{fig:per-task-accuracy}
...
within the stated Uniform Herding protocol; they do not establish effects beyond
this configuration.
The matched per-seed changes are visualized in Appendix~Figure~\ref{fig:app-component-attribution}.
