% --- System overview: reference replay configuration ---
...
\caption{Overview of the reference replay configuration.  Orange boxes mark
the four components varied in the ablation study: classifier head, training
loss, exemplar selection, and evaluation readout; the reference choice is
listed first in each annotation.  Dashed arrows show the memory feedback loop
