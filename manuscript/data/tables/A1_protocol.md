...
| Head | cosine_margin (scale 30.0, margin 0.35, weight imprinting of each new task's head rows after task 0); linear for a3 |
| Optimizer | SGD lr 0.1 / momentum 0.9 / weight decay 0.0005, grad clip 1.0, no LR schedule, warmup 0 |
| Epochs per task | 70 configured; 71 recorded for all 33 seeds (off-by-one in the epoch counter) |
| Batch size | 128 |
| Precision | 16-mixed |
| Seeds | 1993, 2023, 42 |
| Exemplar budgets | 500 (s1); 2000 (B1, B2, B3, a1, a2, a3, a4, s3, s4); 4000 (s2) |
...
| Git commits | a1, a2, a3, a4, s1, s2, s3, s4 `2444dcd1` (dirty); B3 `3436665a` (dirty); B1, B2 `9dde4622` (dirty) |
